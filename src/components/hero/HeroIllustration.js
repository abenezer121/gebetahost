...
import SVG from '../../assets/img/burgerpizza.svg';
				...
				>
					<defs>
						<linearGradient
							...
							id="squares-1-a"
						>
							<stop stopColor="#fd8000" offset="0%" />
							<stop stopColor="#fd8000" stopOpacity="0" offset="100%" />
						</linearGradient>
					</defs>
					<path
				...
				>
					<defs>
						...
						>
							...
							<stop stopColor="#fd8000" offset="100%" />
						</radialGradient>
						<filter
							x="-500%"
							y="-500%"
			...
			<div className="hero-ball hero-ball-2 is-revealing">
				...
				>
					...
					<circle
						...
						fillRule="evenodd"
					/>
					<img width="50px" src={SVG} alt="Gebeta Logo"/>  
				</svg>
				...
				>
					<defs>
						...
						<linearGradient
							...
							id="browser-e"
						>
							<stop stopColor="#fd4000" offset="0%" />
							<stop stopColor="#fd8000" offset="100%" />
						</linearGradient>
						...
						<linearGradient
							...
							id="browser-l"
						>
							<stop stopColor="#fd8000" stopOpacity="0" offset="0%" />
